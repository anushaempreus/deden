    ...
    <>
          ...
          <div style={{ display:"grid", gridTemplateColumns:"1.1fr 0.9fr", gap:"0", alignItems:"center" }}>
            <div style={{ paddingRight:"64px", borderRight:`1px solid ${BORDER}` }}>
              ...
              <div style={{ display:"flex", gap:"12px" }}>
                ...
                <Link href="#how-it-works" style={{ background:"transparent", color:INK, border:`1.5px solid ${BORDER}`, padding:"13px 28px", fontFamily:F, fontSize:"13px", fontWeight:500, textDecoration:"none", borderRadius:"40px" }}>How it works ↓</Link>
              </div>
            </div>
      ...
      <section id="how-it-works" style={{ background:WHITE, padding:"88px 5%" }}>
        ...
        <div style={{ display:"flex", flexDirection:"column" }}>
          {steps.map((s,i) => (
            <div key={s.num}
              style={{ display:"grid", gridTemplateColumns:"240px 1fr", borderBottom:i<steps.length-1?`1px solid ${BORDER}`:"none", background:WHITE, transition:"background 0.2s" }}
            ...
            >
              <div style={{ padding:"36px 32px", display:"flex", alignItems:"flex-start", gap:"14px", borderRight:`1px solid ${BORDER}` }}>
                ...
                <div style={{ width:"42px", height:"42px", borderRadius:"12px", background:OR3, border:`1px solid ${OR4}`, display:"flex", alignItems:"center", justifyContent:"center", flexShrink:0, marginTop:"4px" }}>
      ...
      <section style={{ background:SOFT, padding:"88px 5%" }}>
        <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:"0", alignItems:"start" }}>
          ...
          <div style={{ paddingLeft:"64px", display:"grid", gridTemplateColumns:"1fr 1fr", gap:"16px" }}>
            {reasons.map(r => (
              <div key={r.title}
                style={{ padding:"22px", background:WHITE, border:`1px solid ${BORDER}`, borderRadius:"16px", transition:"border-color 0.2s, transform 0.2s" }}
      ...
      <section style={{ background:CREAM, padding:"88px 5%" }}>
        <div style={{ display:"grid", gridTemplateColumns:"1fr 1.6fr", gap:"0", alignItems:"start" }}>
          <div style={{ paddingRight:"64px", borderRight:`1px solid ${BORDER}` }}>
            ...
            <Link href="/contact" style={{ background:OR, color:"#fff", padding:"12px 24px", fontFamily:F, fontSize:"13px", fontWeight:600, textDecoration:"none", borderRadius:"40px", display:"inline-block" }}>Ask Us Anything</Link>
          </div>
          <div style={{ paddingLeft:"64px" }}>
            {faqs.map((faq,i) => (
              <div key={i} style={{ padding:"22px 0", borderBottom:i<faqs.length-1?`1px solid ${BORDER}`:"none" }}>
                <p style={{ fontFamily:S, fontSize:"1.05rem", color:INK, marginBottom:"9px", fontWeight:400 }}>{faq.q}</p>
                <p style={{ fontFamily:F, fontSize:"14px", color:MUTED, lineHeight:1.75, fontWeight:300 }}>{faq.a}</p>
              </div>
            ))}
          </div>
        </div>
