    ...
    <>
        ...
        <div style={{ position:"relative", zIndex:1, width:"100%" }}>
          ...
          <div style={{ display:"grid", gridTemplateColumns:"1.1fr 0.9fr", gap:"0", alignItems:"center" }}>
            <div style={{ paddingRight:"64px", borderRight:`1px solid ${BORDER}` }}>
              ...
              <a href="#articles" style={{ background:OR, color:"#fff", padding:"13px 28px", fontFamily:F, fontSize:"13px", fontWeight:600, textDecoration:"none", borderRadius:"40px", display:"inline-block" }}>Read the latest ↓</a>
            </div>
      ...
      {featured && activeCat==="All" && (
        <section style={{ background:WHITE, padding:"88px 5%" }}>
          ...
          <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", borderRadius:"20px", overflow:"hidden", border:`1px solid ${BORDER}`, transition:"border-color 0.2s, transform 0.2s" }}
            onMouseEnter={e => { const el=e.currentTarget as HTMLDivElement; el.style.borderColor=OR; el.style.transform="translateY(-3px)"; }}
          ...
          >
            ...
            <div style={{ padding:"48px", background:WHITE, display:"flex", flexDirection:"column", justifyContent:"center" }}>
              ...
              <Link href={`/blog/${featured.slug}`} style={{ background:OR, color:"#fff", padding:"12px 24px", fontFamily:F, fontSize:"13px", fontWeight:600, textDecoration:"none", borderRadius:"40px", display:"inline-block", alignSelf:"flex-start" }}>Read article →</Link>
            </div>
          </div>
        </section>
      )}
      ...
      <section id="articles" style={{ background:SOFT, padding:"88px 5%" }}>
        ...
        <div style={{ display:"grid", gridTemplateColumns:"repeat(3,1fr)", gap:"20px" }}>
          {filtered.map(post => (
            <div key={post.slug}
              style={{ background:WHITE, borderRadius:"20px", border:`1px solid ${BORDER}`, overflow:"hidden", display:"flex", flexDirection:"column", position:"relative", transition:"border-color 0.2s, transform 0.2s" }}
              onMouseEnter={e => { const el=e.currentTarget as HTMLDivElement; el.style.borderColor=OR; el.style.transform="translateY(-4px)"; }}
              onMouseLeave={e => { const el=e.currentTarget as HTMLDivElement; el.style.borderColor=BORDER; el.style.transform="translateY(0)"; }}
            >
              ...
              <div style={{ padding:"16px 28px 24px", borderTop:`1px solid ${BORDER}`, display:"flex", justifyContent:"space-between", alignItems:"center" }}>
                ...
                <Link href={`/blog/${post.slug}`} style={{ fontFamily:F, fontSize:"12px", fontWeight:600, color:OR, textDecoration:"none" }}>Read →</Link>
              </div>
            </div>
          ))}
        </div>
      ...
      <section style={{ background:CREAM, padding:"88px 5%" }}>
        <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:"0", alignItems:"center" }}>
          ...
          <div style={{ paddingLeft:"64px", display:"flex", flexDirection:"column", gap:"16px" }}>
            <Link href="/contact" style={{ background:OR, color:"#fff", padding:"14px 32px", fontFamily:F, fontSize:"13px", fontWeight:600, textDecoration:"none", borderRadius:"40px", display:"inline-block", alignSelf:"flex-start" }}>Book a Free Consultation</Link>
