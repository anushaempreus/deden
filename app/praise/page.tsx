    ...
    <>
      ...
      <section style={{ background:SOFT, padding:"88px 5%" }}>
        ...
        <div style={{ display:"grid", gridTemplateColumns:"repeat(3,1fr)", gap:"20px" }}>
          {testimonials.map(t => (
            <div key={t.name}
              style={{ background:WHITE, borderRadius:"20px", padding:"32px", border:`1px solid ${BORDER}`, position:"relative", overflow:"hidden", transition:"border-color 0.2s, transform 0.2s", display:"flex", flexDirection:"column" }}
